...
export const lineup: Lineup = {
  ...
  entries: [
    { slot: 'QB', player: starters[3] },
    { slot: 'RB', player: starters[0] },
    { slot: 'WR', player: starters[1] },
    { slot: 'TE', player: starters[2] },
    { slot: 'FLEX' },
  ],
};

export const fantasyNightDashboard: FantasyNightDashboard = {
  nflState: defaultNflState,
  meta: {
